...
public class EventProducer {
  ...
  private Producer<Long, CategoryEvent> producer;
  ...
  public void send(CategoryEvent event) {
    ProducerRecord<Long, CategoryEvent> record = new ProducerRecord<>(EventConfig.CATEGORY_TOPIC, event);
