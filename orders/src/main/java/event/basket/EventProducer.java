...
public class EventProducer {
  ...
  private Producer<Long, BasketEvent> producer;
  ...
  public void send(BasketEvent event) {
    ProducerRecord<Long, BasketEvent> record = new ProducerRecord<>(EventConfig.BASKET_TOPIC, event);
