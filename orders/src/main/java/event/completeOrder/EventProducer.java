...
public class EventProducer {
  ...
  private Producer<Long, CompleteOrderEvent> producer;
  ...
  public void send(CompleteOrderEvent event) {
    ProducerRecord<Long, CompleteOrderEvent> record = new ProducerRecord<>(EventConfig.COMPLETE_ORDER_TOPIC, event);
